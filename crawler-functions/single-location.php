...
try {
    $fbgr = $fb->get( '/'.$fbid.'?fields=id,about,location,name,description,picture.type(large),category,phone,emails,website,events{cover{source},name,description,id,start_time,end_time,place,ticket_uri}' );
